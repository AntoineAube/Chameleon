...
@DisplayName("Horizontal linear pattern")
class HorizontalLinearConcretePatternTest {
    ...
    void shouldCorrectlyBrowseASquaredPicture() {
        HorizontalLinearConcretePattern pattern = new HorizontalLinearConcretePattern(new SimpleTestPicture(3, 3));
